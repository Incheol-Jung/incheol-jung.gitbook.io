...
```java
@Entity
@IdClass(Parentld.class)
public class Parent {
  @Id
  @Column(name = "PARENT_ID1")
  private String id1; //Parentld.idl과연결
...
```java
public class Parentld implements Serializable {
  private String id1; //Parent.id1 매핑
  private String id2; //Parent.id2 매핑

  public Parentld() { }

  public Parentld(String id1, String id2) {
    this.id1 = id1;
    this.id2 = id2;
  }
...
```java
em.createQuery(nselect p.id.id1, p.id.id2 from Parent p"); //@Embeddedld
