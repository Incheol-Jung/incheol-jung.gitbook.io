...
![https://s3-us-west-2.amazonaws.com/secure.notion-static.com/11a81164-2e4e-45e8-8221-4b0ecd2d208d/Untitled.png](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/11a81164-2e4e-45e8-8221-4b0ecd2d208d/Untitled.png)
...
스프링 데이터 JPA로 지포지터리를 개발하면 인터페이스만 정의하고 구현체는 만들지 않는다. 하지만 다양한 이유로 메소드를 직접 구현해야 할 때도 있다. 그렇다고 리포지터리를 직접 구현하면 공통 인터페이스가 제공하는 기능까지 모두 구현해야 한다. 스프링 데이터 JPA는 이런 문제를 우회해서 필요한 메소드만 구현할 수 있는 방법을 제공한다.
